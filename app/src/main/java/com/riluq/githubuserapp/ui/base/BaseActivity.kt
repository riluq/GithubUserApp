...
import com.riluq.githubuserapp.ui.receiver.AlarmReceiver
import com.riluq.githubuserapp.utils.NetworkUtils
...
abstract class BaseActivity<T : ViewDataBinding, V : BaseViewModel> : AppCompatActivity(),
    ...
    override fun onResume() {
        super.onResume()
        if (getViewModel()?.getReminder()!!) {
            AlarmReceiver.reminderOn(this)
        } else {
            AlarmReceiver.reminderOff(this)
        }
    }
